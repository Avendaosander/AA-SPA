         ...
         <main className='flex flex-col justify-center items-center text-base sm:text-lg md:text-xl'>
            <section className='p-10 flex flex-col sm:flex-row justify-between items-center sm:text-left gap-5 font-medium'>
               ...
               <p>
                  ...
                  Relajación AA SPA. Aquí encontrarás el equilibrio perfecto
            ...
            <section className='bg-emerald-200 p-10 flex flex-col-reverse sm:flex-row justify-between items-center sm:text-right gap-5 font-medium'>
               <p>
            ...
            <section className='bg-emerald-200 p-10 flex flex-col-reverse sm:flex-row justify-between items-center sm:text-right gap-5 font-medium'>
               <p>
                  En AA SPA, contamos con un equipo de terapeutas expertos en
            ...
            <section className='bg-emerald-200 p-10 flex flex-col-reverse sm:flex-row justify-between items-center sm:text-right gap-5 font-medium'>
               <p>
                  Te invitamos a reservar tu momento de bienestar en AA SPA. Ya
            ...
            <section className='p-10 flex flex-col sm:flex-row justify-between items-center sm:text-left gap-5 font-medium'>
               <p>
                  ¡Ven y descubre la paz interior en el Spa de Relajación AA
                  SPA!
               </p>
            </section>
         </main>
